...
print("  d2_combined_annotations.csv")
...
print("  - Each consensus label is EXACTLY one of: anger, happiness, intense emotions, neutral, sadness")
...
df.to_csv('d2_final_accuracy_results.csv', index=False, encoding='utf-8-sig')
files.download('d2_final_accuracy_results.csv')