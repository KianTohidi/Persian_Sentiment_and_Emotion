...
print("  d3_combined_annotations.csv")
...
print("  - Each consensus label is EXACTLY one of: anger, fear, happiness, hate, other, sadness, surprise")
...
df.to_csv('d3_final_accuracy_results.csv', index=False, encoding='utf-8-sig')
files.download('d3_final_accuracy_results.csv')