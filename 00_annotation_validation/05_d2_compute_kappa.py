...
print("  1. d2_ground_truth.csv   -> original file, unmodified")
print("  2. d2_annotator1.csv     -> fully filled in by Annotator 1")
print("  3. d2_annotator2.csv     -> fully filled in by Annotator 2")
...
print("  - Each label is EXACTLY one of: anger, happiness, intense emotions, neutral, sadness")
...
# auto-renamed them (e.g. "d2_annotator1 (1).csv") due to a naming clash
expected_files = ['d2_ground_truth.csv', 'd2_annotator1.csv', 'd2_annotator2.csv']
uploaded_names = list(uploaded.keys())

def find_uploaded_match(expected_name, uploaded_names):
    base = expected_name.replace('.csv', '')
    # Matches "d2_annotator1.csv", "d2_annotator1 (1).csv", "d2_annotator1(2).csv", etc.
...
gt_df = pd.read_csv(file_map['d2_ground_truth.csv'], encoding='utf-8-sig')
a1_df = pd.read_csv(file_map['d2_annotator1.csv'], encoding='utf-8-sig')
a2_df = pd.read_csv(file_map['d2_annotator2.csv'], encoding='utf-8-sig')
...
summary_df.to_csv('d2_combined_annotations.csv', index=False, encoding='utf-8-sig')
files.download('d2_combined_annotations.csv')