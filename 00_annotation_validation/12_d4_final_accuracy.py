...
print("  d4_combined_annotations.csv")
...
print("  - Each consensus label is EXACTLY one of: anger, fear, happiness, hatred, sadness, wonder")
...
df.to_csv('d4_final_accuracy_results.csv', index=False, encoding='utf-8-sig')
files.download('d4_final_accuracy_results.csv')