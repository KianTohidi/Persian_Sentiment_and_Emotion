...
print("  d5_combined_annotations.csv")
...
print("  - Each consensus label is EXACTLY one of: anger, fear, happiness, other, sadness")
...
df.to_csv('d5_final_accuracy_results.csv', index=False, encoding='utf-8-sig')
files.download('d5_final_accuracy_results.csv')