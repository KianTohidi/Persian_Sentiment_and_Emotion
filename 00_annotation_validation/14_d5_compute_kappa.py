...
print("  1. d5_ground_truth.csv   -> original file, unmodified")
print("  2. d5_annotator1.csv     -> fully filled in by Annotator 1")
print("  3. d5_annotator2.csv     -> fully filled in by Annotator 2")
...
print("  - Each label is EXACTLY one of: anger, fear, happiness, other, sadness")
...
# auto-renamed them (e.g. "d5_annotator1 (1).csv") due to a naming clash
expected_files = ['d5_ground_truth.csv', 'd5_annotator1.csv', 'd5_annotator2.csv']
uploaded_names = list(uploaded.keys())

def find_uploaded_match(expected_name, uploaded_names):
    base = expected_name.replace('.csv', '')
    # Matches "d5_annotator1.csv", "d5_annotator1 (1).csv", "d5_annotator1(2).csv", etc.
...
gt_df = pd.read_csv(file_map['d5_ground_truth.csv'], encoding='utf-8-sig')
a1_df = pd.read_csv(file_map['d5_annotator1.csv'], encoding='utf-8-sig')
a2_df = pd.read_csv(file_map['d5_annotator2.csv'], encoding='utf-8-sig')
...
ACCEPTED_LABELS = ['anger', 'fear', 'happiness', 'other', 'sadness']
...
summary_df.to_csv('d5_combined_annotations.csv', index=False, encoding='utf-8-sig')
files.download('d5_combined_annotations.csv')