...
print("Please upload dataset file: dataset5.csv")
print("\n")
...
ground_truth_df.to_csv('d5_ground_truth.csv', index=False, encoding='utf-8-sig')
annotator1_df.to_csv('d5_annotator1.csv', index=False, encoding='utf-8-sig')
annotator2_df.to_csv('d5_annotator2.csv', index=False, encoding='utf-8-sig')

# Step 11: Download
files.download('d5_ground_truth.csv')
files.download('d5_annotator1.csv')
files.download('d5_annotator2.csv')
...
print("(lowercase, no extra spaces) for each of the 150 rows: anger, fear, happiness, other, sadness.")